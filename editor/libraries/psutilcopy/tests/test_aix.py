...
class AIXSpecificTestCase(unittest.TestCase):
    ...
    def test_virtual_memory(self):
        ...
        psutil_result = psutilcopy.virtual_memory()
    ...
    def test_swap_memory(self):
        ...
        MB = 1024 ** 2
        psutil_result = psutilcopy.swap_memory()
    ...
    def test_cpu_stats(self):
        ...
        psutil_result = psutilcopy.cpu_stats()
        self.assertAlmostEqual(
    ...
    def test_cpu_count_logical(self):
        ...
        psutil_lcpu = psutilcopy.cpu_count(logical=True)
        self.assertEqual(mpstat_lcpu, psutil_lcpu)

    def test_net_if_addrs_names(self):
        out = sh('/etc/ifconfig -l')
        ifconfig_names = set(out.split())
        psutil_names = set(psutilcopy.net_if_addrs().keys())
